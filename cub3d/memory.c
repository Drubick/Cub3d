...
int	load_images(t_info *info)
{
	...
	info->images_E = mlx_xpm_file_to_image(info->mlx,
			info->E_texture_path, &p, &j);
	info->images_W = mlx_xpm_file_to_image(info->mlx,
			info->W_texture_path, &p, &j);
	info->images_S = mlx_xpm_file_to_image(info->mlx,
			info->S_texture_path, &p, &j);
	info->images_N = mlx_xpm_file_to_image(info->mlx,
